...
const recentBuyers = [
  { name: "Mike T.", location: "New York", time: "2 minutes ago" },
  { name: "Rachel K.", location: "Los Angeles", time: "5 minutes ago" },
  { name: "David M.", location: "Chicago", time: "8 minutes ago" },
  { name: "Jennifer S.", location: "Houston", time: "12 minutes ago" },
  { name: "Chris P.", location: "Phoenix", time: "15 minutes ago" },
  { name: "Amanda L.", location: "Miami", time: "18 minutes ago" },
  { name: "Brian W.", location: "Seattle", time: "22 minutes ago" },
  { name: "Lisa R.", location: "Denver", time: "25 minutes ago" },
];
...
export function SocialProofPopup() {
  ...
  useEffect(() => {
    const initialDelay = setTimeout(() => setIsVisible(true), 8000);
    ...
    >
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-gray-600 mt-0.5">
            Just purchased AuraGlow Whitening Kit
          </p>
      ...
      <div className="mt-3 pt-3 border-t border-gray-100 flex items-center justify-between">
        <div className="flex items-center gap-1">
          {[...Array(5)].map((_, i) => (
            <svg key={i} className={`w-3 h-3 ${i < 4 ? "text-amber-400" : "text-gray-300"}`} fill="currentColor" viewBox="0 0 20 20">
              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
            </svg>
          ))}
          <span className="text-xs text-gray-500 ml-1">40,000+ reviews</span>
        </div>
