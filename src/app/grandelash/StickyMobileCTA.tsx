...
export function StickyMobileCTA({ amazonLink }: StickyMobileCTAProps) {
  return (
    <>
      <div
        className="fixed bottom-0 left-0 right-0 bg-white border-t-2 border-rose-200 px-3 pt-2.5 pb-3 md:hidden z-[9999] shadow-[0_-4px_20px_rgba(0,0,0,0.2)]"
      >
        <AmazonButton
          href={amazonLink}
        ...
        <div className="flex items-center justify-center gap-3 mt-1.5">
          <span className="text-xs text-gray-500 flex items-center gap-1">
            <span className="text-green-500">✓</span> Prime Shipping
          </span>
          <span className="text-xs text-gray-500 flex items-center gap-1">
            <span className="text-green-500">✓</span> 30-Day Guarantee
          </span>
          <span className="text-xs text-gray-500 flex items-center gap-1">
            <span className="text-green-500">✓</span> $36
          </span>
        </div>
      </div>
