...
const ALLOWED_PAGES = ["/auraglow", "/grandelash", "/shark-flexstyle", "/sharkflex", "/BirkenstockArizona", "/BirkenstockTraffic", "/BirkenstockSales", "/BirkenstockInstagram", "/BirkenstockAudience", "/UggScuffette", "/NewBalance928", "/GrandeLashMD"];
