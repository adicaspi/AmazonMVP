...
const ALLOWED_PAGES = ["/auraglow", "/shark-flexstyle", "/sharkflex", "/BirkenstockArizona", "/BirkenstockTraffic", "/BirkenstockSales", "/BirkenstockInstagram", "/BirkenstockAudience", "/UggScuffette", "/UggClassic", "/NewBalance928", "/GrandeLashMD"];
