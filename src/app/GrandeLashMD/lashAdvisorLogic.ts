...
const PRIORITY_REASON: Record<string, string> = {
  ...
  cost: "The 4mL bottle is a 6-month supply — per month it works out far cheaper than extension refills",
};
    ...
    return {
      ...
      note:
        a.routine === "unsure"
          ...
          : `${baseNote} One bottle is an upfront spend — it works out as a 6-month supply, but only if you use it consistently.`,
      showCta: true,
    };
  }
