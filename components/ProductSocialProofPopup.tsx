...
const recentBuyers = [
  { name: "David K.", location: "New York", time: "2 minutes ago" },
  { name: "Rachel S.", location: "Los Angeles", time: "5 minutes ago" },
  { name: "Michael T.", location: "Chicago", time: "8 minutes ago" },
  { name: "Sarah L.", location: "Houston", time: "12 minutes ago" },
  { name: "James W.", location: "Phoenix", time: "15 minutes ago" },
  { name: "Emma R.", location: "Miami", time: "18 minutes ago" },
  { name: "Daniel P.", location: "Seattle", time: "22 minutes ago" },
  { name: "Olivia M.", location: "Denver", time: "25 minutes ago" },
];

interface ProductSocialProofPopupProps {
  productName: string;
}

export function ProductSocialProofPopup({ productName }: ProductSocialProofPopupProps) {
    ...
    >
      ...
      <div className="mt-3 pt-3 border-t border-gray-100 flex items-center justify-between">
        <div className="flex items-center gap-1">
          ...
          <span className="text-xs text-gray-500 ml-1">Highly Rated</span>
        </div>
